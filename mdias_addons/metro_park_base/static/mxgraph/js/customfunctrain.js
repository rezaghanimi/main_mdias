...
class graphx {
    ...
    generateVessel(position, CB) {
        ...
        let traincell = graph.insertVertex(graph.model.cells[1], null, value, 0, 0, 220, 30, "text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;fontColor=#FFFFFF;");
        this.setLabelText(traincell, `<div  style="visibility:unset" class='trainvessel trainvesseltrain' id="V${position}"></div>`)
...
//列车左键点击
window.addEventListener('clicktrain', e => {
    console.log('点击列车：', e.detail)
})
