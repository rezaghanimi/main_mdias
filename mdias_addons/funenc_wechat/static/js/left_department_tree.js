 ...
 */
odoo.define('left_department_tree', function (require) {
    'use strict';
    ...
    var left_department_tree = ListView.extend({
    ...
    view_registry.add("left_department_tree", left_department_tree);
});
