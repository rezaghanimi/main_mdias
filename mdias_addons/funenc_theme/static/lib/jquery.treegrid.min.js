...
(function($) {
    ...
    var methods = {
        ...
        initExpander: function() {
            ...
            var cell = $this.find('td .o_data_cell ').get($this.treegrid('getSetting', 'treeColumn'));
    ...
    /**
     * 这个可以，通过treegrid来调用方法，好像jquery都比较喜欢这种写法呢
     */
    ...
    $.fn.treegrid.defaults = {
        ...
        getNodeId: function() {
            ...
            if (template.test($(this).attr('class'))) {
                console.log(template.exec($(this).attr('class'))[1]);
        ...
        /**
         * 有tree-grid标识，但又没有tree-grid-parent标识
         * @param {*} treegridContainer 
         */
