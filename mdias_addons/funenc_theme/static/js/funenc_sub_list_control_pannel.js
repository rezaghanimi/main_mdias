odoo.define('web.SubControlPanelMixin', function (require) {
    "use strict";
...
odoo.define('web.SubControlPanel', function (require) {
    "use strict";
    ...
    var SubControlPanel = Widget.extend({
        template: 'SubControlPanel',
        /**
