...
Actions.prototype.init = function () {
	...
	// park map actions
	// 删除占线板
	this.addAction('delete_busy_icon', function (cell) {
		var graph = ui.editor.graph;
		graph.fireEvent(new mxEventObject('delete_busy_icon', 'cell', cell));
	}, null, null, null);

	// 删除列车组
	this.addAction('delete_train_group', function (cell) {
		var graph = ui.editor.graph;
		graph.fireEvent(new mxEventObject('delete_train_group', 'cell', cell));
	}, null, null, null);

	// 删除车厢
	this.addAction('delete_train_carriage', function (cell) {
		var graph = ui.editor.graph;
		graph.fireEvent(new mxEventObject('delete_train_carriage', 'cell', cell));
	}, null, null, null);
