...
Menus.prototype.createPopupMenu = function(menu, cell, evt)
{
	if (cell) {
		...
		var is_busy_icon = cell.getAttribute('is_busy_icon')
		if (is_busy_icon) {
			this.addMenuItems(menu, ['delete_busy_icon'], null, cell);
			return
		}

		var is_carriage = cell.getAttribute("is_carriage")
		if (is_carriage) {
			this.addMenuItems(menu, ['delete_train_carriage'], null, cell);
			return
		}
	}
};
